<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="메뉴 ID" v-model="value.menuId" :editMode="editMode" :inputUI="''"/>
            <Number label="수량" v-model="value.amount" :editMode="editMode" :inputUI="''"/>
            <OrderDetail offline label="" v-model="value.세부주문" :editMode="editMode" @change="change"/>
        </v-card-text>
