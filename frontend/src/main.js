...
pluralCaseList.push( {plural: "orderAndPayments/orders", pascal: "OrderAndPaymentOrder"} )

pluralCaseList.push( {plural: "deliveryManagements/deliveries", pascal: "DeliveryManagementDelivery"} )

pluralCaseList.push( {plural: "customerServices/customerInquiries", pascal: "CustomerServiceCustomerInquiry"} )

pluralCaseList.push( {plural: "marketingAdvertisings/marketingCampaigns", pascal: "MarketingAdvertisingMarketingCampaign"} )

pluralCaseList.push( {plural: "itTechnologyServerManagements/systemManagements", pascal: "ItTechnologyServerManagementSystemManagement"} )
